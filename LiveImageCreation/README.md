...
```
On my machine, the USB stick is the one 'Mounted on' '/run/media/znmeb/606C-2D0F'.
1. Yours will probably be different, but the '/run/media' part should be the same.
1. Write down the 'Filesystem' name for that row, in this case, '/dev/sdc1'.
